...
const typeColors: Record<string, string> = {
  ...
  datasheet: "bg-purple-100 text-purple-700",
};
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-4xl mx-auto">
          {downloads.map((download, i) => (
            <motion.a
              ...
              className="group flex flex-col items-center p-5 bg-white rounded-xl border border-slate-200 hover:border-blue-300 hover:shadow-md transition-all"
            >
              ...
              <p className="mt-3 text-sm font-semibold text-slate-800 text-center line-clamp-2">
                {download.title}
              </p>
              <span
              ...
              <p className="mt-1 text-xs text-slate-400">{download.fileSize}</p>
