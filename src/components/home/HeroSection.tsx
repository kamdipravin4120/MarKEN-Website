        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-4 py-2 bg-blue-500/10 border border-blue-400/20 rounded-full text-blue-300 text-sm mb-6"
            >
            ...
            >
              <Link
                href="/products"
                className="inline-flex items-center gap-2 px-6 py-3.5 bg-blue-600 text-white font-semibold rounded-xl hover:bg-blue-500 transition-all shadow-lg shadow-blue-600/25"
              >
                Explore Products
          ...
          >
            <div className="relative aspect-square max-w-lg mx-auto">
              ...
              <div className="relative bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-8 h-full flex flex-col items-center justify-center">
